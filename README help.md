...
=======
# TagCloudReact
First what you need to do, to open server by node.js
  ---It meens you open cd/server and write like that: "node index.js"
  
 Then you need open project odessa and try it by your self.Dont forget write "npm start" in console, and check cd/odessa
>>>>>>> 9a308504aae6b17a23aedae2e394cc01ca7d869a
